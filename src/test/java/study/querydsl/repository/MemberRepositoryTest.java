...
class MemberRepositoryTest {
    ...
    /**
     * 동적쿼리 - Builder 조회 테스트
     * searchByBuilder (동적쿼리 - Builder)
     * search (동적 쿼리와 성능 최적화 조회)
     * 커스텀 리포지토리 동작 테스트 추가 (MemberRepository extends MemberRepositoryCustom)
     */
    @Test
...
//        List<MemberTeamDto> result = memberRepository.searchByBuilder(condition);
     ...
     * 장점: Pagable, Sort를 모두 지원하고 정상 동작한다.
     * 단점 :
